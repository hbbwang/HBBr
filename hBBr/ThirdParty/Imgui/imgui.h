...
namespace ImGui
{
    ...
    IMGUI_API bool          TreeNodeEx(const char* label, ImTextureID nodeTexture, ImGuiTreeNodeFlags flags = 0);
...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_CustomArrow          = 1 << 16,
...
enum ImGuiCol_
{
    ...
    ImGuiCol_TreeNodeItemSearchResult,
    ImGuiCol_COUNT,
