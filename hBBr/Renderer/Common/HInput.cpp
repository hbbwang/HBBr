...
{
    if (VulkanApp::Get()->GetFocusWindow() && VulkanApp::Get()->GetFocusWindow()->GetWindowHandle())
    {
        SDL_WarpMouseInWindow(VulkanApp::Get()->GetFocusWindow()->GetWindowHandle(), pos.x, pos.y);
    }
}
