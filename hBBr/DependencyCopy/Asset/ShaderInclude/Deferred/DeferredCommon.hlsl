...
Texture2D GBuffer0: register(t1,space1);
SamplerState GBuffer0Sampler: register(s1,space1);

//GBuffer1 World Normal & ? 
Texture2D GBuffer1: register(t2,space1);
SamplerState GBuffer1Sampler: register(s2,space1);

//GBuffer2 Metallic & Specular & AO & ShadingModel ID
Texture2D GBuffer2: register(t3,space1);
SamplerState GBuffer2Sampler: register(s3,space1);
